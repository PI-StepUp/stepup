				...
				<div className="signup-block-center">
					...
					<div className="signup-content">
						<form>
							...
							<input type="date" data-placeholder={lang === "en" ? "Date of birth" : lang === "cn" ? "出生年月日" : "생년월일"} required aria-required="true" className="input-birthday" onChange={(e) => setBirth(e.target.value)} />
							<select>
								{
