...
import static com.pi.stepup.domain.music.constant.MusicResponseMessage.UPDATE_MUSIC_SUCCESS;
...
public class MusicApiController {
    ...
    @PutMapping
    public ResponseEntity<ResponseDto> updateMusic(
        @RequestBody MusicUpdateRequestDto musicUpdateRequestDto) {
        musicService.update(musicUpdateRequestDto);
        return ResponseEntity.status(HttpStatus.OK).body(ResponseDto.create(
            UPDATE_MUSIC_SUCCESS.getMessage()
        ));
    }
