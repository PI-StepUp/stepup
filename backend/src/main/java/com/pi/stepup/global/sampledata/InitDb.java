...
public class InitDb {
    ...
    static class InitService {
            ...
            for (int i = 0; i < title.length; i++) {
                String sql =
                        "INSERT INTO board (board_id, created_at, modified_at, writer, title, content,"
                                +
                                " file_url, board_type, view_cnt) VALUES (?, '2023-08-01', '2023-08-01', 1, ?, ?, ?, 'NOTICE',?)";
                ...
                query.setParameter(5, viewCnt[i]);
                query.executeUpdate();
        ...
        public void makeTalk() {
            ...
            for (int i = 0; i < title.length; i++) {
                String sql = "INSERT INTO board (board_id, created_at, modified_at, writer, title, content," +
                        " file_url, board_type, view_cnt) VALUES (?, '2023-08-02', '2023-08-02', ?, ?, ?, ?, 'TALK',?)";
                ...
                query.setParameter(6, viewCnt[i]);
                query.executeUpdate();
        ...
        public void makeMeeting() {
            ...
            for (int i = 0; i < title.length; i++) {
                String sql = "INSERT INTO board (board_id, created_at, modified_at, writer, title, content," +
                        " file_url, board_type, view_cnt) VALUES (?, '2023-08-03', '2023-08-03', ?, ?, ?, ?, 'MEETING',?)";
